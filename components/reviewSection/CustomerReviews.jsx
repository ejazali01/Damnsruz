...
const CustomerReviews = () => {
  ...
  {/* 1st */}
    <div className="flex items-center lg:w-3/5 mx-auto hover:bg-slate-400 border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
...
{/* 2nd */}
    <div className="flex items-center lg:w-3/5 hover:bg-slate-400 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
      <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
...
{/* 3rd */}
    <div className="flex items-center lg:w-3/5 hover:bg-slate-400 mx-auto sm:flex-row flex-col">
      <div className="sm:w-32 sm:h-32 h-20 w-20 sm:mr-10 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="sm:w-16 sm:h-16 w-10 h-10" viewBox="0 0 24 24">
